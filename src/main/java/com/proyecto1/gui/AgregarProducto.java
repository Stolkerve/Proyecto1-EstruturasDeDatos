...
public class AgregarProducto extends MenuComponent {
    /**
     * @param AgregarProducto Se crea una variable (importada anteriormente) de vector
     **/
    ...
    int stock;
    /**
     * @param DefaultComboBoxModelSe crea una ComboBox para la cantidad de almacenes disponibles
     **/
    ...
    public AgregarProducto(MainPanel mainMenuPanel) {
        ...
        botonGuardar.setEnabled(true);
         /**
        * @param AgregarProducto Aqui obtenemos los datos del usuario de su seleccion de almacenes
        **/
    }
    ...
    @SuppressWarnings("unchecked")
     /**
        * @param encontrarProducto Un verificador para ver si el producto escrito por el usuario existe o no en los almacenes
        **/
    ...
    /**
        * @param cargarCombo Agregar un nuevo almacen
        **/
    ...
    /**
        * @param buscarWearhouse Llamamos la funcion vectores anteriormente creada y creamos una funcion para verificar los warehouses
        **/
    ...
    /**
     * @param validarInt Verifica si el input del usuario es un numero
     **/
    ...
    /**
     * Funcion para validar si el nombre del producto escrito por el usuario es un String o si este ya se encuentra en el almacen
     * @param validarStr Ademas de verificar el dato del usuario limpia el espacio del input del usuario
     **/
    ...
    /**
     * Este es un boton que sirve para guardar los inputs del usuario
     * @param botonGuardarActionPerformed Se guarda el input del usuario y se verifica si el dato es correcto
     **/
