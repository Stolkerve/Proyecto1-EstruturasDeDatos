        ...
        SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                AssetInfo[] assetsLoadInfo = new AssetInfo[] {
                        new AssetInfo(getClass().getResource("/proyecto1/estruturasdedatos/assets/cat-kiss.gif").getPath(), "cat-kiss", AssetType.Image),
                        new AssetInfo(getClass().getResource("/proyecto1/estruturasdedatos/assets/Amazon_icon.png").getPath(), "amazon-icon", AssetType.Image),
                        new AssetInfo(getClass().getResource("/proyecto1/estruturasdedatos/assets/left-arrow.png").getPath(), "left-arrow", AssetType.Image),
                        new AssetInfo(getClass().getResource("/proyecto1/estruturasdedatos/assets/BetterCallSaulRemix.wav").getPath(), "background-music", AssetType.Music),
                };
